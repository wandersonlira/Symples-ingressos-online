...
public class Eventos implements Serializable{
	...
	public Eventos(Integer idEvento, String nomeEvento, Date dataEvento, Time horaEvento, Integer ingressos,
			Integer ingressoComprado, String categoria, Endereco codigoEndereco) {
		super();
